...
function ensureR05Map(d){
  const mf=d?.getElementById('mapFrame');
  if(!mf||mf.dataset.beta2R05==='1')return;
  mf.dataset.beta2R05='1';
  mf.src='japan-map-r05-wrapper.html?game=1&rev=r20260827-05&nocache='+Date.now();
}
function tick(){
