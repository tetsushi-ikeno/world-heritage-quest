...
const criteria=[
 {n:1,count:5,roman:'i',icon:'🏛',title:'人類の創造力',note:'人が生み出した、特にすぐれた傑作'},
 {n:2,count:13,roman:'ii',icon:'↔',title:'文化の交流',note:'建築や技術などを通じた文化や考え方の交流'},
 {n:3,count:10,roman:'iii',icon:'🗿',title:'文化・文明の証言',note:'ある文化や文明を今に伝える大切な証拠'},
 {n:4,count:12,roman:'iv',icon:'⚙',title:'歴史を伝える建築・技術',note:'歴史の大切な時代を伝える建物や技術'},
 {n:5,count:3,roman:'v',icon:'🏘',title:'伝統的な暮らし・土地利用',note:'人々の伝統的な暮らしや土地との関わり'},
 {n:6,count:10,roman:'vi',icon:'🎨',title:'出来事・思想・信仰・芸術',note:'大切な出来事、考え方、信仰、芸術などとの結びつき'},
 {n:7,count:1,roman:'vii',icon:'🏔',title:'すばらしい自然景観',note:'とても美しい自然や、すばらしい自然現象'},
 {n:8,count:0,roman:'viii',icon:'🪨',title:'地球の歴史・地形',note:'地球の歴史や地形のでき方を伝えている'},
 {n:9,count:4,roman:'ix',icon:'🌿',title:'生態系のしくみ',note:'生きものと環境が関わりながら変化・発展していくしくみ'},
 {n:10,count:2,roman:'x',icon:'🐾',title:'生物多様性・生息地',note:'さまざまな生きものを守るために大切な場所'}
];
...
const intro=[
 {title:'もっと世界遺産を知りたい',text:'ある日、主人公は世界遺産の本を読んでいた。\n\n写真だけでもおもしろい。けれど、どうして世界遺産になったのか、もっと詳しく知りたくなった。'},
 {title:'世界遺産研究センターからの荷物',text:'そのとき、小さな荷物が届いた。\n送り主は「世界遺産研究センター」。\n\n箱の中から、三角形のふしぎな相棒が飛び出した！'},
 {title:'ぼくはピラミトン！',text:'「ぼくはピラミトン！ 世界遺産研究センターから来たんだ。\n本で読むのもいいけれど、実際に日本をめぐって調べてみない？」\n\nこうして、世界遺産をめぐる旅が始まる。'}
];
