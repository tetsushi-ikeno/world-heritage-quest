...
window.WHQBetaSave={KEY,fresh,load,save,update,reset,centerState,setCenterState,BETA_REV};
...
if(document.getElementById('titleScreen')&&!document.querySelector('script[data-whq-beta-hotfix]')){
  ...
  script.src='beta-hotfix-loader.js?v=20260822-8';
