...
const fresh=()=>({version:2,playerName:'',tutorialComplete:false,map:{position:null,path:[],returnLockSiteId:null,returnLockBranchId:null},discovered:[],branches:[],branchQuizDone:[],centers:{}});
